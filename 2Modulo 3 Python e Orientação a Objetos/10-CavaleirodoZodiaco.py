...
class CavaleiroDeBronze(Personagem):
    ...
    def golpe_especial(self):
        print(f"\n{self.nome} executa seu golpe {self.poder_de_luta}!")


class CavaleiroDePrata(Personagem):
    def __init__(self, nome, constelacao, habilidade):
        super().__init__(nome, constelacao)
        self.habilidade = habilidade

    def golpe_especial(self):
        print(f"\n{self.nome} utiliza sua habilidade de prata: {self.habilidade}!")
...
def main():
    ...
    while True:
        ...
        if opcao == "1":
            print("\nTipo de Cavaleiro:")
            print("1. Cavaleiro de Ouro")
            print("2. Cavaleiro de Prata")
            print("3. Cavaleiro de Bronze")
            ...
            if tipo == "1":
                ...
                personagem = CavaleiroDePrata(nome, constelacao, habilidade)
            ...
            if not personagens:
                ...
                for p in personagens:
                    ...
                    if isinstance(p, CavaleiroDePrata):
                        p.golpe_especial()
